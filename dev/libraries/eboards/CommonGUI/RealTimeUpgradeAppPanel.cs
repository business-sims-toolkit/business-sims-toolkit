...
namespace CommonGUI
{
	public class RealTimeUpgradeAppPanel : UpgradeAppControl
	{
		Label hourLabel;

		public RealTimeUpgradeAppPanel (OpsControlPanelBase mainPanel, IncidentApplier incidentApplier,
		                                NodeTree model,
		                                bool showMinutesNotDays, bool isTraining,
		                                Color backColour, Color groupBackColour)
			: base (mainPanel, incidentApplier, model, showMinutesNotDays, isTraining, backColour, groupBackColour)
		{
		}
		...
		protected override Panel CreateWhenEntryPanel ()
		{
			...
			hourLabel = new Label ();
			hourLabel.Font = MyDefaultSkinFontBold10;

...
{
    public class DevOpsOperationsScorecardReportBuilder : BaseScorecardReport<DevOpsRoundScores>
    {
        public DevOpsOperationsScorecardReportBuilder (NetworkProgressionGameFile gameFile, List<DevOpsRoundScores> roundScores, bool includeTotalColumn = true)
        ...
        void AddItPerformanceSection()
        {
            ...
            AddMetricRow(results, "Prevented Failures", score => score.PreventedIncidents, TotalStyle.Total, FigureFormatting.Integer);

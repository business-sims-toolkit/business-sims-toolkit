...
{
	public class DevOpsBusinessScorecard : BaseScorecardReport<DevOpsRoundScores>
    {

        public DevOpsBusinessScorecard(NetworkProgressionGameFile gameFile, List<DevOpsRoundScores> scores) :

...
{
	/// <summary>
	/// This is a very simple place holder control for display FSC and other updates 
	//  In the old style of a single panel with a colored background 
	/// </summary>
	public class GameOps_FSC_Display : FlickerFreePanel
	{
		...
		public GameOps_FSC_Display(NodeTree model, bool IsTrainingGame)
		{
